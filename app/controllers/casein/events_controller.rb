...
module Casein
  class EventsController < Casein::CaseinController
    ...
    def index
      ...
      @events = Event.order(sort_order(:type)).paginate page: params[:page]
    end
    ...
    def event_params
      params.require(:event).permit(
        :type, :start_date, :end_date, :description, :is_published, :recap_url,
        :home_team_a, :home_team_b, :visiting_team_a, :visiting_team_b, :ticket_url
      )
    end
  end
end
